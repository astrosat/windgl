...
class WindGL {
    ...
    setProperty(property, value) {
        switch(property) {
            ...
            case 'particle-reset-factor':
                ...
                break;
            case 'particle-count':
                const particleRes = this.particleStateResolution = Math.ceil(Math.sqrt(value));
            ...
            case 'wind-speed-color-ramp':
                this._color_ramp = value;
                if (this.gl) {
                    this.setColorRamp(this.gl, this._color_ramp);
                }
                break;
            default:
    ...
    onAdd(map, gl) {
      ...
      this.setColorRamp(gl, this._color_ramp);
    ...
    setColorRamp(gl, colors) {
        ...
        this.colorRampTexture = util.createTexture(gl, gl.LINEAR, getColorRamp(colors), 16, 16);
    }
